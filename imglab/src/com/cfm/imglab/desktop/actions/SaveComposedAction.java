...
public class SaveComposedAction extends AbstractAction {
	
	private ImgLabFrame frame;
	
	public SaveComposedAction(ImgLabFrame imgLabFrame) {
		this.frame = imgLabFrame;
		
		putValue(Action.NAME, "Save Composed...");
